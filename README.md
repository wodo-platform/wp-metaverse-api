...
<div align="center">
<h2> Wodo Platform Metaverse API Definitions </h2>
</div>
...
- [Adding wp-metaverse-api dependency](#adding-wp-metaverse-api-dependency)
...
Please follow the steps below to publish wp-metaverse-api npm package from your local development environment.
...
Verif that wp-metaverse-api package has been published successfully with the correct version you provided in package.json file. Go to the page below and make sure that your packge is listed on the  published artifact list
...
```
"dependencies": {
        "@wodo-platform/wp-metaverse-api": "1.0.0",
...
##  Adding wp-metaverse-api dependency

To be able to add wp-metaverse-api as npm dependency, you need to authenticate to git remote npm package repository by logging in to npm, use the npm login command, replacing USERNAME with your GitHub username, TOKEN with your personal access token, and PUBLIC-EMAIL-ADDRESS with your email address.
